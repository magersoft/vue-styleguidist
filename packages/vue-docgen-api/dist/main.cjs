...
var tsConfigPaths__namespace = /*#__PURE__*/_interopNamespaceDefault(tsConfigPaths);
...
function getSourceCode(path) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, promises.readFile(path, { encoding: 'utf-8' })];
        });
    });
}
function findClosestTsconfig(startPath) {
    ...
    while (dir !== path.dirname(dir)) {
        var candidate = path.join(dir, tsconfigFilename);
...
function getFromPathsInFileByImportsOrExports(source, sourcePath, query) {
    ...
    var tsConfig = tsConfigPaths__namespace.loadConfig(tsconfigPath);
    if (tsConfig.resultType === 'success') {
        var matchPath_1 = tsConfigPaths__namespace.createMatchPath(tsConfig.baseUrl, tsConfig.paths);
        return matches
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    rawPath = path.join(path.dirname(sourcePath), filePath);
                    isDirectory = node_fs.existsSync(rawPath);
                    if (!isDirectory) return [3 /*break*/, 11];
                    return [4 /*yield*/, promises.readFile(path.join(rawPath, "index.".concat(opt.lang)), { encoding: 'utf-8' })];
                case 2:
                    indexFile = _c.sent();
                ...
                case 4:
                    ...
                    fileName = "".concat(fileName.replace(".".concat(path.sep), ''), ".").concat(opt.lang);
                    return [4 /*yield*/, promises.readFile(path.join(rawPath, fileName), { encoding: 'utf-8' })];
                case 5:
                ...
                case 9:
                    ...
                    return [7 /*endfinally*/];
                case 10: return [2 /*return*/, path.join(rawPath, composableFileName)];
                case 11:
                    composableFilePath = "".concat(rawPath, ".").concat(opt.lang);
                    return [4 /*yield*/, promises.readFile(composableFilePath, { encoding: 'utf-8' })];
                case 12:
                    fileContent = _c.sent();
...
function parseAstFromComposableFile(path, opt) {
    return __awaiter(this, void 0, void 0, function () {
        var plugins_1, composableFile_1, ast, _a, componentDefinitions;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                ...
                case 1:
                    ...
                    ast = cacher(function () { return recast.parse(composableFile_1, { parser: buildParse({ plugins: plugins_1 }) }); }, composableFile_1);
                    if (!ast) {
                        throw new Error("Unable to parse empty file \"".concat(path, "\""));
                    }
                    _a = __read(resolveExportedComponent(ast), 1), componentDefinitions = _a[0];
                    // @ts-ignore
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    objPropFiltered = objProp.filter(function (p) { return bt__namespace.isProperty(p.node) || bt__namespace.isSpreadElement(p.node); });
                    return [4 /*yield*/, Promise.all(objPropFiltered.map(function (prop) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        propNode = prop.node;
                                        if (!bt__namespace.isSpreadElement(propNode)) return [3 /*break*/, 3];
                                        spreadElementName = 
                                        // @ts-ignore
                                        propNode.argument.type === 'CallExpression' ? propNode.argument.callee.name : propNode.argument.name;
                                        return [4 /*yield*/, parseSpreadProperties(spreadElementName, composableFullfilePath || documentation.componentFullfilePath, opt)];
                                    case 1:
                                    ...
                                    case 3:
                                        ...
                                        if (!(bt__namespace.isArrayExpression(propValuePath.node) || bt__namespace.isIdentifier(propValuePath.node))) return [3 /*break*/, 4];
                                        // if it's an immediately typed property, resolve its type immediately
                                        propDescriptor.type = getTypeFromTypePath(propValuePath);
                                        return [3 /*break*/, 7];
                                    case 4:
                                        if (!bt__namespace.isObjectExpression(propValuePath.node)) return [3 /*break*/, 6];
